...
export function EditBar({editing, saveState, adminPath, pages, onEnter, onSave, onDiscard, onTheme, onPages}) {
    if (!editing) {
    ...
    return <div className="edit-bar editing">
        ...
        <button type="button" className="button button-ghost" onClick={onPages}>Pages</button>
        <button type="button" className="button button-ghost" onClick={onTheme}>Theme</button>
